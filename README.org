...
Code Pro and Roboto Mono. All great, readable fonts.
...
(defun load-dark-theme ()
  ...
  (set-face-attribute 'org-block nil :background "#242424")
  (set-face-attribute 'mode-line-inactive nil :background "#242424")
  (set-face-attribute 'ein:cell-input-area nil :background "#242424"))
#+END_SRC
