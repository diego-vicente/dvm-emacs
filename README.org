...
(defun set-custom-font (frame)
  (interactive)
  (set-face-attribute 'default nil :font "Iosevka SS10 12"))
...
(substitute-key-definition 'quit-window 'quit-window-dwim global-map)
(substitute-key-definition 'quit-window 'quit-window-dwim help-mode-map)
(substitute-key-definition 'quit-window 'quit-window-dwim Buffer-menu-mode-map)
#+END_SRC
...
(use-package lsp-ui
  ...
  (set-face-attribute 'lsp-ui-doc-background  nil :background "#2A2A2A")
