...
management to i3 completely.

#+BEGIN_SRC emacs-lisp :results silent
(setq-default pop-up-frames 'graphic-only)

;; Fix quit-window definitions to get rid of buffers
(substitute-key-definition 'quit-window 'delete-frame global-map)
(substitute-key-definition 'quit-window 'delete-frame help-mode-map)
#+END_SRC
...
(use-package magit
  ...
  (setq-default magit-bury-buffer-function 'delete-frame)
