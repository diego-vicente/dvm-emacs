...
(use-package doom-themes
  ...
  (setq bg-color "#2F343F")
  (set-background-color bg-color)
  ;; There has to be a better way
  (set-face-background 'org-level-1 bg-color)
  (set-face-background 'org-level-2 bg-color)
  (set-face-background 'org-level-3 bg-color)
  (set-face-background 'org-level-4 bg-color)
  (set-face-background 'org-level-5 bg-color)
  (set-face-background 'org-level-6 bg-color)
  (set-face-background 'org-level-7 bg-color)
  (set-face-background 'org-level-8 bg-color)
...
#+BEGIN_SRC emacs-lisp
(setq org-ellipsis " ⤵")
(add-hook 'org-mode-hook '(lambda () (set-face-background 'org-ellipsis bg-color)))
#+END_SRC
