...
(use-package doom-themes
  ...
  (set-face-background 'org-level-1 "#2F343F")
  (set-face-background 'org-level-2 "#2F343F")
  (set-face-background 'org-level-3 "#2F343F")
  (set-face-background 'org-level-4 "#2F343F")
  (set-face-background 'org-level-5 "#2F343F")
  (set-face-background 'org-level-6 "#2F343F")
  (set-face-background 'org-level-7 "#2F343F")
  (set-face-background 'org-level-8 "#2F343F")
  (set-face-background 'org-block-begin-line "#2F343F")
  (set-face-background 'org-block-end-line "#2F343F")
  (set-face-background 'org-ellipsis "#2F343F")
)
#+END_SRC

** ~spaceline~ configuration

After a lot of time using ~smart-mode-line~, I finally decided to give a shot
to ~spaceline~, which enables a more ~powerline~-like aesthetic. I also
integrate the colors with the rest of the theme.
...
(use-package spaceline-config
  ...
  (set-face-background 'spaceline-highlight-face "DodgerBlue2")
