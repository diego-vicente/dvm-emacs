...
This package let us enable multiple cursors, by pressing the key defined below
(~C-c m~), we can create one cursor in each of the lines included in the visual
region. This is incredibly powerful wen using ~evil~ as well.
